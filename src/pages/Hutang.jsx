      ...
      <div className="">
        <div className="bg-white rounded-[20px] py-4 px-6 shadow-md">
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-1 py-1 text-center">
                            <button
                              className="bg-[#1E686D] hover:bg-green-600 text-white px-3 py-1 rounded-[10px] text-xs mr-2"
          ...
          <div className="flex justify-left pt-4">
            <button
              className="bg-[#1E686D] hover:bg-green-600 text-white px-4 py-2 rounded-[10px] text-xs font-semibold"
